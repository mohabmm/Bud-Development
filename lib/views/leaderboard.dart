                                           ...
                                           new Container(
                                              ...
                                              Column(
                                                children: <Widget>[
                                                  ...
                                                  Center(child: new Text(numberofridesdriver.toString()+" "+ "rides given")),
                                                  Center(child: new Text(co2driver+" " +"KG C02 saved")),
                                                ],
                                              ),
//         :new Text("a7a"),
                                        ],
...
//                                    ),
              ...
              StreamBuilder<QuerySnapshot>(
                stream: Firestore.instance.collection('users')
                    .where("passengerrate", isGreaterThan: "1").orderBy('passengerrate', descending: true).limit(10).snapshots(),                builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                    ...
                    default:
                      return ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            ...
                            snapshot.data.documents[index].data['First Name '];
                            int numberofridesdriver = snapshot.data.documents[index].data['Number Of Rides As Driver'];
                            String CO2passenger = snapshot.data.documents[index].data['CO2passenger'];
                            String passengerrate = snapshot.data.documents[index].data['passengerrate'];
                                              ...
                                              children: <Widget>[
                                                ...
                                                Column(
                                                  children: <Widget>[
                                                    ...
                                                    Center(child: new Text(numberofridesdriver.toString()+" "+ "rides given")),
                                                    Center(child: new Text(CO2passenger+" " +"KG C02 saved")),
                                                  ],
                                                ),
//         :new Text("a7a"),
                                              ],
